...
public class AffectStatistic {
     ...
     */
    public void statisticAffectClass(final ClassLoader loader, final String javaClassName) {
     ...
     */
    public void statisticAffectMethod(final ClassLoader loader, final Set<String> behaviorSignCodes) {
     ...
     * @param behaviorSignCodes 行为签名集合
     */
    public void statisticAffect(final ClassLoader loader, final String internalClassName, final Set<String> behaviorSignCodes) {
    ...
    private Set<String> computeUniqueCode(final ClassLoader loader, final Set<String> behaviorSignCodes) {
